  ...
  <div class="home" style="height: 100%">
    <el-container style="height:100%">
      ...
      <el-aside :width="collapse ? '64px':'200px'">
        <div v-show="!collapse" class="manager">
          <div class="avator">
        ...
        <div class="list">
          ...
          >
            <el-submenu index="1">
              ...
              <NuxtLink to="/Home/options1">
                <el-menu-item index="/options1/1-1">
                  1-1
                </el-menu-item>
              </NuxtLink>
            </el-submenu>
            <el-submenu index="2">
              ...
              <NuxtLink to="/Home/options2">
                <el-menu-item index="/options2/2-1">
                  2-1
                </el-menu-item>
              </NuxtLink>
            </el-submenu>
            <el-submenu index="3">
              ...
              <NuxtLink to="/Home/options3">
                <el-menu-item index="/options3/3-1">
                  3-1
                </el-menu-item>
              </NuxtLink>
            </el-submenu>
      ...
      <el-container style="width: 100%">
        <el-header height="100px">
            ...
            <el-col :span="7" class="notes" :offset="2">
              <el-row :gutter="10" type="flex" align="middle">
                ...
                <el-col :span="6">
                  <el-dropdown>
                    <span class="el-dropdown-link">
                      王某人<i class="el-icon-arrow-down el-icon--right" />
                    </span>
                    <el-dropdown-menu slot="dropdown">
          ...
          <!--侧边菜单栏-->
          <RightMenu :active-tab="activeTab" :menu-toggle="menuToggle" :left-toggle="collapse" @leftToggle="AsideToggle" />
        </el-header>
